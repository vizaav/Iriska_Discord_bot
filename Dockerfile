...
RUN adduser --disabled-login --shell /bin/bash iris

USER iris

WORKDIR /home/iris/bot
...
ENV ENV PYTHONPATH "${PYTHONPATH}:/home/iris/bot"

# What the container should run when it is started.
ENTRYPOINT [ "poetry", "run", "python3", "-OO", "-m", "iriska" ]
